...
public class IANegaMax : BaseIA
{
    ...
    protected override void PlayIA()
    {
        ...
        Debug.Log("generation best coup");
        Coup coup = BestCoup(2, 1);

        //Distinction de cas MUR et MOUVEMENT
        
        if (coup is CoupWall coupWall)
        {
            Debug.Log("coup is coup wall");
